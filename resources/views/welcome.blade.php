                ...
                <div class="container px-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item px-lg-3"><a class="nav-link text-uppercase" href="./">Início</a></li>
                            <li class="nav-item px-lg-3"><a class="nav-link text-uppercase" href="CapsDrogas">Caps Álcool e Drogas</a></li>
                            <li class="nav-item px-lg-3"><a class="nav-link text-uppercase" href="CapsAdulto">Caps Adulto </a></li>
                            <li class="nav-item px-lg-3"><a class="nav-link text-uppercase" href="CapsInf">Caps Infantil</a></li>
                            <li class="nav-item px-lg-3"><a class="nav-link text-uppercase" href="outros">Outros</a></li>
                            <div class="hidden top-0 right-0 sm:block">
                                @if (Route::has('login'))
                                    @auth
                                    <li class="nav-item px-lg-3"><a href="{{ url('/dashboard') }}" class="nav-link text-uppercase">Painel</a></li>
                                    @else
                                        <li class="nav-item px-lg-3 w-8"><a href="{{ route('login') }}" class="nav-link text-uppercase">Entrar</a></li>
                                            @if (Route::has('register'))
                                                <li class="nav-item px-lg-3 w-8"><a href="{{ route('register') }}" class="nav-link text-uppercase">Cadastrar</a>
                                            @endif
                                        </li>
                                    @endauth
                                @endif
